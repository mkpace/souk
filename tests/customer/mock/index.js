const MOCK_CUSTOMER = {
  ...
  user: {
    ...
    password: 'password',
    roles: ['administrator'],
    dt_created: '2018-08-28T14:24:16.724Z',
    dt_updated: '2018-08-28T14:24:16.724Z',
  },
  dt_registered: '2018-08-28T14:24:16.724Z',
  dt_updated: '2018-08-28T14:24:16.724Z',
  dt_last_active: '2018-08-27T19:47:59.237Z',
  dt_approved: '2018-08-27T19:47:59.237Z',
  type: 'wholesale',
  company: 'Wholesaler',
  billing: {
    first_name: 'Cheryl',
...
const UPDATED_MOCK_CUSTOMER = {
  user: {
    first_name: 'angiel',
    last_name: 'lucasl',
    username: `angie.lucasl${Date.now()}`,
    email: `angie.lucasl${Date.now()}@gmail.com`,
    status: 'approved',
  },
  company: 'HP Pavilion',
  referredby: 'Unknown',
